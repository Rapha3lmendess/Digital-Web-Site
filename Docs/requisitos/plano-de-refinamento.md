...
7. Publicar esta branch na Vercel com site estático e API na mesma origem. `API_BASE_URL` permanece vazio; validar `/api/health`, Auth, pedidos, perfil e CORS same-origin no domínio atribuído.
